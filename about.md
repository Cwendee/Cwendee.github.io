...
<section class="max-w-5xl mx-auto px-4 py-12" data-aos="fade-up" data-aos-delay="200">
  ...
  <div class="flex flex-wrap gap-4">
    ...
    <div class="bg-gray-700 rounded-lg px-4 py-2 text-gray-200 hover:shadow-lg hover:shadow-blue-400 transition">🛠️ Women Techsters Fellowship DevOps Engineering Track | 2025 – 2026</div>
    <div class="bg-gray-700 rounded-lg px-4 py-2 text-gray-200 hover:shadow-lg hover:shadow-blue-400 transition">☁️ AWS Certified Cloud Practitioner ALX Africa | June 2025</div>
    <div class="bg-gray-700 rounded-lg px-4 py-2 text-gray-200 hover:shadow-lg hover:shadow-blue-400 transition">⚙️ DevOps Engineering LearnWithPride Limited | Sept 2024</div>
    <div class="bg-gray-700 rounded-lg px-4 py-2 text-gray-200 hover:shadow-lg hover:shadow-blue-400 transition">🔐 Microsoft Learning Series Cybersecurity & Cloud | 2023 – 2024</div>
  </div>
</section>
